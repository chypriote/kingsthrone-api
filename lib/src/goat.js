...
class Goat {
    constructor() {
        ...
        this.challenges = {
            ...
            alliancePower: new endpoints_1.AlliancePower(this),
            allianceSiege: new endpoints_1.AllianceSiege(this),
            allianceChampionship: new endpoints_1.AllianceChampionship(this),
            charm: new endpoints_1.Charm(this),
            deathmatch: new endpoints_1.Deathmatch(this),
            equipment: new endpoints_1.Equipment(this),
            feastPoints: new endpoints_1.FeastPoints(this),
            grain: new endpoints_1.Grain(this),
            intimacy: new endpoints_1.Intimacy(this),
            kingdomPower: new endpoints_1.KingdomPower(this),
            loseSoldiers: new endpoints_1.LoseSoldiers(this),
            xsIntimacy: new endpoints_1.XSIntimacy(this),
            ...
            rareBeasts: new endpoints_1.RareBeasts(this),
            spendGold: new endpoints_1.SpendGold(this),
            tourney: new endpoints_1.TourneyChallenge(this),
