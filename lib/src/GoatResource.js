...
exports.GoatResource = exports.LOGIN_ACCOUNT_NAPOLEON = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const axios_1 = require("axios");
exports.LOGIN_ACCOUNT_NAPOLEON = { 'rsn': '2axwqwhxyx', 'login': { 'loginAccount': {
...
class GoatResource {
    ...
    async request(data = null) {
        if (!this._goat.isLoggedIn) {
            await this.login(exports.LOGIN_ACCOUNT_NAPOLEON);
        }
