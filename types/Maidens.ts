export const MAIDENS = [
	...
	{ mid: 27, name: 'Brunhilde', visits: 0 },
	{ mid: 29, name: 'Elise', visits: 0 },
	{ mid: 30, name: 'Helen', visits: 0 },
	{ mid: 31, name: 'Jeanne', visits: 0 },
	{ mid: 35, name: 'Morrigan', visits: 0 },
	{ mid: 36, name: 'Mulan', visits: 0 },
	{ mid: 37, name: 'Ginchiyo', visits: 0 },
	{ mid: 46, name: 'Elizabeth', visits: 0 },
	{ mid: 71, name: 'Louise', visits: 0 },
	{ mid: 202, name: 'Circe', visits: 0 },
	{ mid: 204, name: 'Adira', visits: 0 },
	{ mid: 210, name: 'Sari', visits: 0 },
	{ mid: 212, name: 'Scheherazade', visits: 0 },
	{ mid: 319, name: 'Morgause', visits: 0 },
]
